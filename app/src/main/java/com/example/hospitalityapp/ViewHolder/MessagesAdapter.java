...
public class MessagesAdapter extends RecyclerView.Adapter<MessagesAdapter.MessageViewHolder> {
    ...
    public class MessageViewHolder extends RecyclerView.ViewHolder
    {
        ...
        public TextView SenderMessagegText,ReceiverMessagegText,MessageDateandtime;
        ...
        public MessageViewHolder(@NonNull View itemView)
        {
            ...
            MessageDateandtime = itemView.findViewById(R.id.messagetime);
    ...
    public void onBindViewHolder(@NonNull final MessageViewHolder messageViewHolder, int position)
    {
...

        {
            ...
            if (fromUserID.equals(messageSenderID))
            {
                ...
                messageViewHolder.MessageDateandtime.setText(messages.getDate()+" "+messages.getTime());

                messageViewHolder.SenderMessagegText.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        messageViewHolder.MessageDateandtime.setVisibility(View.VISIBLE);

                    }
                });


                messageViewHolder.ReceiverMessagegText.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        messageViewHolder.MessageDateandtime.setVisibility(View.VISIBLE);
