...
public class MesageAdminActivity extends AppCompatActivity {
...
//                SendMessage();
...

            {
                ...
                RootRef.updateChildren(messageBodyDetails).addOnCompleteListener(new OnCompleteListener() {
                    ...
                    public void onComplete(@NonNull Task task)
                    {
                        ...
                        {
                            Toast.makeText(MesageAdminActivity.this, "Message Sent Successfully ", Toast.LENGTH_SHORT).show();
                        ...
                        else
                        {
                            ...
                            Toast.makeText(MesageAdminActivity.this, "Error Occurred:" + messaege, Toast.LENGTH_SHORT).show();
                            userMessageInput.setText("");
    ...
    private void FetchMessages()
    {
        ...
        RootRef.child("Messages").child(messageSenderID).child(messaReceiverID)
    ...
    private void getUserName()
    {
        ...
        UserRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                {
                    Toast.makeText(MesageAdminActivity.this, "Please fill your Profile data before sending a message", Toast.LENGTH_SHORT).show();
                }
