...
public class AddProductActivity extends AppCompatActivity {
    ...
    private void saveProductInfoToDatabase()
    {
        ...
        productsRef.child("LocationSort").child(Location).child(Category).child(CurrentUserID).child(productRandomKey).updateChildren(productMap)
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task)
                    {
                        if (task.isSuccessful())
                        {
                            ...
                            productsRef.child("CategorySort").child(Location).child(CatergorySpinner).child(productRandomKey).updateChildren(productMap);
        ...
        UserRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                if (dataSnapshot.exists())
                {
                    ...
                    Toast.makeText(AddProductActivity.this, sLocation, Toast.LENGTH_SHORT).show();
                ...
                {
                    Toast.makeText(AddProductActivity.this, "No info saved in your profile", Toast.LENGTH_SHORT).show();
                }
